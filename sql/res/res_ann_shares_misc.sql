...
WITH meta_filtered AS (
	SELECT meta."in.county",
		...
		sum(meta."out.natural_gas.grill.energy_consumption" + meta."out.natural_gas.fireplace.energy_consumption" + meta."out.natural_gas.lighting.energy_consumption" + "out.natural_gas.permanent_spa_heat.energy_consumption" + "out.natural_gas.pool_heater.energy_consumption") as misc_ng
