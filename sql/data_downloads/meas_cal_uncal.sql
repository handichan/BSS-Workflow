...
sector, 
end_use, 
sum(county_hourly_uncal_kwh) as uncal_kwh, 
sum(county_hourly_cal_kwh) as cal_kwh
...
sector, 
end_use, 
cal_kwh/uncal_kwh as cal_over_uncal
FROM agg),
...
scout.sector, 
state_ann_kwh_uncal, 
state_ann_kwh_uncal * cal_over_uncal as state_ann_kwh_cal
