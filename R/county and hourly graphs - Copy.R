...
#sample sizes
ns<-arrow::read_parquet("ResStock2024_2baseline_amy.parquet",col_select = c("bldg_id","in.county")) %>% group_by(in.county) %>% summarize(n=n())
...
save_plot(paste0("graphs/",filename,".jpg"),p,base_height = 12,bg="white")
...
save_plot("graphs/county_100_hrs_share.jpg",p100,base_height = 12,bg="white")
...
p100_hist<-county_100_hrs_share %>%
  ...
  theme(panel.grid.minor.y = element_blank(),axis.title = element_blank(),plot.margin=margin(b = 0),
        strip.background = element_blank(),strip.text.y = element_text(angle=-90,size=12),strip.text.x = element_text(size=12))+
  ggtitle("Share of Top 100 Hours in the Winter")
save_plot("graphs/county_100_hrs_share_hist.jpg",p100_hist,base_height = 6,base_width = 12,bg="white")
...
save_plot("graphs/county_ratio.jpg",ratio_map,base_height = 12,bg="white")
...
ratio_hist<-peak_ratio %>%
  ...
  theme(panel.grid.minor.y = element_blank(),axis.title = element_blank(),plot.margin=margin(b = 0),
        strip.background = element_blank(),strip.text.y = element_text(angle=-90,size=12),strip.text.x = element_text(size=12))+
  ggtitle("Ratio of Winter Peak to Summer Peak")
save_plot("graphs/county_ratio_hist.jpg",ratio_hist,base_height = 6,base_width = 12,bg="white")
...
save_plot("graphs/example_peak_days.jpg",psample,base_height = 6,base_width = 12,bg="white")
...
save_plot("graphs/eia_seasonal_ratio_comp.jpg",eia_comp,base_height = 6,base_width = 12,bg="white")
